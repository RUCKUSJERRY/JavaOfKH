...
public class Mtest {
	...
	// 전역변수 : 해당 클래스 어디서든 사용할 수 있는 변수
	public static int ten = 10;
	
	// 상수 : 변수 앞에 final
	// 상수의 메소드명은 대문자로 쓰는게 암묵적인 국룰이다.
	public static final int TEN = 10;
	
	public static void main(String [] args) {
		
		// 전역변수 지역변수의 이름이 같으면 "지역변수"가 우선이다!
		// 지역변수
		int ten = 100;
	...
	public static void op03(int a, int b) {
		...
		System.out.println(a++);		//11 위에꺼 값을 먼저 리턴
		System.out.println(a);			//12 위에꺼 연산 나중에 한 값
		// a = 12 b = 3
		int result = a++ + --b + b++ + ++a;
		// result = 12(13) + 2(2) + 2(3) + 14
		// a = 14 b = 3
